...
const handlevalidPassword2 = (val) => {
 ...
 <View>
   <View style={{marginBottom:20,marginTop:70}}><Text style={{textAlign:'center',fontSize:30}}>Manager Profile View</Text></View>
 <View style={{marginTop:height/7.9,elevation:10,alignItems:'center',margin:40}}>
