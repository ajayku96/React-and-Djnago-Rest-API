...
<View style={styles.inputContainer}>
        ...
        <TouchableOpacity style={[styles.regButtonContainer, styles.RegisterButton]} onPress={() => signUp(data.username,data.email,data.mobile,data.name,data.password,data.password2)} >
